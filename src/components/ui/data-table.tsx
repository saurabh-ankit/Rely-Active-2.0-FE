...
export function DataTable<TData, TValue>({
  ...
  const pageCount =
    manualPagination && customPageCount !== undefined ? customPageCount : table.getPageCount()
  const currentPage =
              ...
              <Pagination className="w-auto mx-0">
                <PaginationContent>
                  <PaginationItem>
                    <PaginationPrevious
                      href="#"
                      aria-disabled={manualPagination && onPageChange ? currentPage === 0 : !table.getCanPreviousPage()}
                      onClick={(e) => {
                        e.preventDefault()
                      ...
                      className={
                        (manualPagination && onPageChange ? currentPage === 0 : !table.getCanPreviousPage())
                  ...
                  <PaginationItem>
                    <PaginationNext
                      href="#"
                      aria-disabled={manualPagination && onPageChange ? currentPage >= pageCount - 1 || pageCount === 0 : !table.getCanNextPage()}
                      onClick={(e) => {
                        e.preventDefault()
                        if (manualPagination && onPageChange) {
                      ...
                      className={
                        (manualPagination && onPageChange ? currentPage >= pageCount - 1 || pageCount === 0 : !table.getCanNextPage())
                          ? 'pointer-events-none opacity-50 bg-gray-50 text-gray-400 border-gray-200 dark:bg-gray-800 dark:text-gray-500'
                          : 'cursor-pointer bg-white text-gray-700 hover:bg-gray-50 border-gray-200 dark:bg-gray-800 dark:text-gray-200'
                      }
                    />
