...
const propertyAssignmentFormSchema = z.object({
  locId: z.string(),
...
const globalServiceFormSchema = z
  .object({
...
type GlobalServiceFormValues = z.infer<typeof globalServiceFormSchema>
type PropertyAssignmentFormValues = z.infer<typeof propertyAssignmentFormSchema>

const globalServiceFormDefaultValues: GlobalServiceFormValues = {
  name: '',
  basePrice: 0,
  description: '',
  propertyAssignments: [],
