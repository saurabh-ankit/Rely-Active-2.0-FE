...
const EventRegistrationsPage = () => {
  ...
  const registrations = Array.isArray(registrationsData?.data?.registrations)
    ...
    : []
  const paginationInfo = registrationsData?.data?.pagination

  // Handle new pagination structure (currentPage, totalPages, totalCount, etc.)
  const totalRecords = paginationInfo?.totalCount || paginationInfo?.total || registrations.length
