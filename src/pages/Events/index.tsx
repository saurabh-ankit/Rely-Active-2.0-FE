...
import { getLocalDayStart, getLocalMonthDateRange } from './utils/eventScheduleUtils'

const EventsCalendar = lazy(() => import('./components/EventsCalendar'))
const EventsListPage = lazy(() => import('./EventsList'))
const VenuesListPage = lazy(() => import('./VenuesList'))
