...
import { useListVenues, useUpdateVenue, useDeleteVenue, useLocationGlobalServices } from '@/hooks/react-query/events'
import {
  ...
  return (
    <div>
      ...
      <Card>
        ...
        <CardContent>
          <DataTable columns={columns} data={venues} pageSize={pagination.pageSize} />
        </CardContent>
      </Card>
